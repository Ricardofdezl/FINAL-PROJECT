{
 "cells": [
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "..          ...              ...       ...              ...      ...   \n",
       "245      159182   Front of Store       Yes         Clothing       No   \n",
       "246      199233            Aisle       Yes         Clothing       No   \n",
       "247      137044            Aisle        No         Clothing      Yes   \n",
       "248      154736   Front of Store       Yes         Clothing      Yes   \n",
       "249      141434   Front of Store        No         Clothing      Yes   \n",
       "\n",
       ...
       "..            ...   ...                                                ...   \n",
       "245          1014  Zara  https://www.zara.com/us/en/basic-100-wool-swea...   \n",
       "246          2222  Zara  https://www.zara.com/us/en/colorblock-knit-cro...   \n",
       "247          2534  Zara  https://www.zara.com/us/en/hooded-technical-ja...   \n",
       "248          1466  Zara  https://www.zara.com/us/en/houndstooth-suit-ja...   \n",
       "249          2870  Zara  https://www.zara.com/us/en/bomber-jacket-p0534...   \n",
       "\n",
       "                  sku                                           name  \\\n",
       ...
       "..                ...                                            ...   \n",
       "245   321993245-500-2  FAUX LEATHER OVERSIZED JACKET LIMITED EDITION   \n",
       "246   330590505-500-2              CONTRASTING PATCHES BOMBER JACKET   \n",
       "247  320680326-107-39                            PATCH BOMBER JACKET   \n",
       "248  311292244-800-39          CROPPED BOMBER JACKET LIMITED EDITION   \n",
       "249  311307610-400-39                     FAUX LEATHER PUFFER JACKET   \n",
       "\n",
       "                                           description  \\\n",
       ...
       "..                                                 ...   \n",
       "245  Jacket made of technical fabric with padded in...   \n",
       "246  Oversized jacket. Notched lapel collar and lon...   \n",
       "247  Varsity jacket with elastic collar and long sl...   \n",
       "248  Varsity jacket with padded interior. Rib elast...   \n",
       "249  Jacket with lightly padded interior. Rib colla...   \n",
       "\n",
       "                     scraped_at    terms section    price€  \n",
       "0    2024-02-19T08:50:05.654618  jackets     MAN   16.9915  \n",
       "1    2024-02-19T08:50:06.590930  jackets     MAN  143.6500  \n",
       "2    2024-02-19T08:50:07.301419  jackets     MAN  109.6500  \n",
       "3    2024-02-19T08:50:07.882922  jackets     MAN  109.6500  \n",
       "4    2024-02-19T08:50:08.453847  jackets     MAN  118.1500  \n",
       "..                          ...      ...     ...       ...  \n",
       "245  2024-02-19T09:10:43.883037  jackets     MAN  143.6500  \n",
       "246  2024-02-19T09:10:44.463883  jackets     MAN  135.1500  \n",
       "247  2024-02-19T09:10:45.009106  jackets     MAN   11.0415  \n",
       "248  2024-02-19T09:10:45.631804  jackets     MAN   16.9150  \n",
       "249  2024-02-19T09:10:31.877972  jackets     MAN   33.9150  \n",
       "\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 28,
   "id": "bb77a9cf-40e6-4148-ae06-5623988be1da",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   ...
   "source": [
    ...
    "massimo_dutti_df['brand'] = \"MASSIMO DUTTI\""
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "\n",
       "       price€  color          brand section  Product ID Promotion  \\\n",
       ...
       "...       ...    ...            ...     ...         ...       ...   \n",
       "101445    NaN    NaN  MASSIMO DUTTI     MAN         NaN       NaN   \n",
       "101446    NaN    NaN  MASSIMO DUTTI     MAN         NaN       NaN   \n",
       "101447    NaN    NaN  MASSIMO DUTTI     MAN         NaN       NaN   \n",
       "101448    NaN    NaN  MASSIMO DUTTI     MAN         NaN       NaN   \n",
       "101449    NaN    NaN  MASSIMO DUTTI     MAN         NaN       NaN   \n",
       "\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 47,
   "id": "896eccee-f952-47f0-899e-235f02997e4e",
   "metadata": {},
   "outputs": [
    {
     "data": {
      "text/plain": [
       "array(['New Balance', 'PUMA', 'Nike', 'UGG', 'Jordan', 'HOKA',\n",
       "       'adidas Originals', 'Timberland', 'adidas', 'Reebok',\n",
       "       'Under Armour', 'On', 'Vans', 'Crocs', 'Polo Ralph Lauren',\n",
       "       'Diadora', 'Converse', 'Brooks', 'Champion',\n",
       "       'All City By Just Don', 'ASICS Tiger', 'ASICS®', 'Asolo',\n",
       "       'Birkenstock', 'Bungee Obleceni', 'Carrots', 'Clarks', 'Colorado',\n",
       "       'Columbia', 'Creative Recreation', 'Cross Colours', 'Feiyue',\n",
       "       'Fila', 'HEYDUDE', 'K-Swiss', 'Kappa', 'Malibu', 'Mizuno',\n",
       "       'OOFOS INC', 'Palladium', 'Salomon', 'Saucony', 'The North Face',\n",
       "       'asos', 'H&M', 'Mango', 'Zara', 'MASSIMO DUTTI'], dtype=object)"
      ]
     },
     "execution_count": 47,
     "metadata": {},
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "...        ...         ...        ...     ...   \n",
       "101445  129.00         NaN    unknown     Man   \n",
       "101446   89.95         NaN    unknown     Man   \n",
       "101447   89.95         NaN    unknown     Man   \n",
       "101448   69.95         NaN    unknown     Man   \n",
       "101449  129.00         NaN    unknown     Man   \n",
       "\n",
       "                                                     name          brand  \\\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 55,
   "id": "d9278e93-aefe-4bea-94aa-aef8c511ff68",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "image/png": "",
      "text/plain": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "t-stat: 12.320986305816437, p_value: 1.0836886716990863e-34\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Mean price for man: 60.48919762727549\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "t-stat: 69.24861235506584, p_value: 1.0\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Mean price for woman: 28.87592054711818, Mean price for Man: 60.48919762727549\n"
     ]
    }
   ],
   "source": [
